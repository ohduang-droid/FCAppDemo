        ...
        <div className="relative z-20 bg-[#F9F9F9] text-[#000000] pb-24">
            <div className="max-w-xl mx-auto px-6 pt-16 sm:pt-24">
                ...
                <div className="flex flex-col items-center mb-12 space-y-2">
                    <span className="text-xs uppercase tracking-widest text-gray-500 font-medium">Curated By</span>
                    <span className="font-serif-luxury text-xl text-[#002349] italic">{author}</span>
                    <span className="text-[10px] text-gray-400 uppercase tracking-wider mt-1">{time}</span>
                </div>
                ...
                {/* Main Article Content (HTML) - Preserved Usage Scenarios */}
                <div
                    className="drop-cap-article prose prose-lg prose-headings:font-serif-luxury prose-headings:font-normal prose-p:font-light prose-li:marker:text-[#B89B5E]"
